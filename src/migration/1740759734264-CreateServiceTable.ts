...
export class CreateServiceTable1740759734264 implements MigrationInterface {
  ...
  `);
      ...
      // Commit transaction before creating indexes concurrently
      await queryRunner.commitTransaction();

      // Create service index separately
  ...
  `);
      ...
      // Create unique index on version table separately
